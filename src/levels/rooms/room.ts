...
const room = (
  ...
  horLine([topLeft[0], topLeft[1] + 1], hor - 2, horWallTile, floor)
  horLine([bottomRight[0], topLeft[1] + 1], hor - 2, horWallTile, floor)

  verLine([topLeft[0] + 1, topLeft[1]], ver - 2, verWallTile, floor)
  verLine([topLeft[0] + 1, bottomRight[1]], ver - 2, verWallTile, floor)
